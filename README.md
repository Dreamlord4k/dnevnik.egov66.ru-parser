...
От пользователя требуются "минимальные" (насколько это в принципе возможно с текущей реализацией) действия.  
...
Для работы парсера не закрывайте консоль. закрытие консоли - остановка программы.  
